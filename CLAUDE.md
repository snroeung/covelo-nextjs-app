...
- **No `src/` directory exists.** All source lives at root-level: `app/`, `components/`, `lib/`, `server/`, `contexts/`, `hooks/`, `supabase/`, `assets/`, `__tests__/`, `e2e/`
...
- Card images: `assets/cards/*.{avif,png}`; ID→import map at `lib/cardImages.ts`
